...
// carta.js
//
// Controller for Arcade Carta Session launching app.
//
...
function getSession() {
  ...
  return new Promise(function (resolve, reject) {
    ...
    request.withCredentials = true
    request.open('GET', ARCADE_ENDPOINT + '?type=carta&status=Running')
    request.send(null)
  })
}
